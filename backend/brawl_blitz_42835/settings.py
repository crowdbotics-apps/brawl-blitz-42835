"""
Django settings for brawl_blitz_42835 project.
...
ROOT_URLCONF = 'brawl_blitz_42835.urls'
...
WSGI_APPLICATION = 'brawl_blitz_42835.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "brawl_blitz_42835 API",
    "DESCRIPTION": "API documentation for brawl_blitz_42835 App",
    "VERSION": "v1",
}
